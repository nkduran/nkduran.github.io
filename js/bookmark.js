/* global CONFIG */
window.addEventListener("DOMContentLoaded",()=>{"use strict";var e,o,t=()=>{localStorage.setItem("bookmark"+location.pathname,window.scrollY)},n=()=>{var e=localStorage.getItem("bookmark"+location.pathname);e=parseInt(e,10),
